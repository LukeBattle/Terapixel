...
Due to this, the runtime of "TotalRender" will not be equal to the summation of the runtimes for the other events. To verify that "Uploading" and "Tiling" are initialised at the same time for all rendering tasks in the file, we can create a vector of the difference between the start time for "Uploading" and "Tiling" in every instance. This is done using the below function with corresponding code.
