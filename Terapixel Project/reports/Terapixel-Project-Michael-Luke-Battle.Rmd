...
EXAMINE IMPACT OF REMOVING FIRST TWO TASKS, USE PLOT AND THEN BACK UP WITH AVERAGE DIFFERENCE BETWEEN RUNTIME AVERAGES

THEN INTRODUCE HISTOGRAM DISTRIBUTION

First, we can examine the average time taken to render a single tile for each virtual machine in both scenarios
